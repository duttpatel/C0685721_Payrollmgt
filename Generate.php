          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i> List Of Employee <small></small></h2>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> Generate Pay Slip For Employee <small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li class="dropdown">
...
<table class="table">
	...
	<?php while($row=mysqli_fetch_array($result)){ ?>
			...
			<td>
				<a class="btn btn-primary" href="GenerateCode.php?id=<?php echo $row['EId']; ?>">Generate</a>
			</td>
